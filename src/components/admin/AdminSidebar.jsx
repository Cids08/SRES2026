...
export default function AdminSidebar({ collapsed }) {
    ...
    return (
        <aside style={{
            ...
            minWidth: W,
            background: NAV,
            /* Key fix: fill exactly the viewport height, never scroll the sidebar itself */
            height: "100vh",
            position: "sticky",
            top: 0,
            display: "flex",
            ...
            overflow: "hidden",   /* hide any accidental overflow — no scrollbar */
            flexShrink: 0,
            zIndex: 50,
        }}>
            ...
            {/* Navigation — fills remaining space, scrolls internally only if needed */}
            <nav style={{
                flex: 1,
                padding: collapsed ? "10px 6px" : "12px 8px",
                overflowY: "auto",
                overflowX: "hidden",
                /* Hide scrollbar visually but allow scroll on overflow */
                scrollbarWidth: "none",
